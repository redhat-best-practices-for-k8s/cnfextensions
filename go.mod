...
require (
	...
	github.com/openshift/machine-config-operator v0.0.0-00010101000000-000000000000 // indirect
	...
	github.com/test-network-function/privileged-daemonset v0.0.7 // indirect
